...
-- Novos temas SINGLE (overlays por código)
L.THEME_SINGLE_NEON_DIAGONAL   = "Neon (Listras diagonais)"
L.THEME_SINGLE_OUTRUN_CHEVRON  = "Outrun (Chevron)"
L.THEME_SINGLE_FEL_DIAGONAL    = "Vil (Listras diagonais)"
L.THEME_SINGLE_ICE_SCANLINES   = "Gelo (Linhas de varredura)"
L.THEME_SINGLE_CARBON_GRID     = "Carbono (Grade)"
L.THEME_SINGLE_GOLD_DIAGONAL   = "Ouro (Listras diagonais)"
L.THEME_SINGLE_BLOOD_CHEVRON   = "Sangue (Chevron)"
L.THEME_SINGLE_ARCANE_DIAGONAL = "Arcano (Listras diagonais)"
L.THEME_SINGLE_MINT_GLASS      = "Menta (Vidro)"

L.THEME_SINGLE_HEAT_SHEAR      = "Calor (Barra inclinada)"
L.THEME_SINGLE_NEON_SHEAR      = "Neon (Barra inclinada)"
